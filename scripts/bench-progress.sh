...
ID=$(./agentctl run --model claude-opus-5-5 --name bench --task "Use bash to run 'echo step1' then 'echo step2' then 'echo step3'. After each, write a paragraph about what you did." --cwd /tmp 2>/dev/null)
